...
from KnarlusLogConsole import log_to_console, log_to_file
from KnarlusReadConfig import get_token
...
guild_ids: list  # = None  # TODO import guild id's via KnarlusReadConfig.py
